...
def train(cfg):
    ...
    if cfg.train.glove:
        ...
        logging.info(train_loader.glove_matrix.shape)
        with torch.no_grad():
    ...
    for epoch in range(start_epoch, cfg.train.max_epochs):
        ...
        for i, batch in enumerate(iter(train_loader)):
            ...
            video_idx, question_idx = batch[0], batch[1]
...
def main():
    ...
    assert cfg.train.k_max_clip_level <= 16
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.train_question_pt = os.path.join(cfg.dataset.data_dir, 'train.pt')
        cfg.dataset.val_question_pt = os.path.join(cfg.dataset.data_dir, 'val.pt')
        cfg.dataset.test_question_pt = os.path.join(cfg.dataset.data_dir, 'test.pt')
